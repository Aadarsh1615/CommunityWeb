...
<head>
    <meta charset="UTF-8">
    <title>Group Info - AdminHub</title>
    ...
    <style>
        ...
        @media (max-width: 900px) {
            ...
            .groups-content-wrapper { padding: 24px 8px 0 8px; }
        }
    </style>
</head>
<body>
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="groups.php" class="sidebar-link active" id="nav-groups"><i data-feather="layers"></i> Group Info</a>
        ...
        <div class="main-area">
            ...
            <div class="topbar">
                <div class="topbar-left">
                    <div class="topbar-logo">
                        ...
                        <span class="topbar-title">Group Info</span>
                    </div>
            ...
            <main class="main-content">
                <div class="groups-content-wrapper">
                    <div class="groups-title">Group Info</div>
                    <div class="groups-subtitle">Overview and management of your community groups.</div>
                    <div class="groups-card">
                        <div class="group-section-title">Groups Overview</div>
                        <div class="group-text">
                            Here you can manage all your community groups, view group statistics, and perform group-related actions.
                        </div>
                        <div class="group-section-title">Create or Edit Groups</div>
                        <div class="group-text">
                            Use the group management tools to add new groups, edit existing ones, or remove groups as needed.
                        </div>
                        <div class="group-section-title">Group Analytics</div>
                        <div class="group-text">
                            Analyze group activity, member participation, and growth trends to keep your community engaged.
                        </div>
                    </div>
                </div>
            </main>
